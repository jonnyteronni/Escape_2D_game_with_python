...
question1 = {
    ...
    "name" : "What is the Capital of Brunei?\n",
}
question2 = {
    "capital" : "Jakarta",
    "name" : "What is the Capital of Indonesia?\n",
}
question3 = {
    "capital" : "Islamabad",
    "name" : "What is the Capital of Pakistan?\n",
}
question4 = {
    "capital" : "Bishkek",
    "name" : "What is the Capital of  Kyrgyzstan?\n"
}
...
def play_room(room):
    ...
    if(game_state["current_room"] == game_state["target_room"]):
        ...
        if len(game_state["keys_collected"]):
            for row_key in game_state["keys_collected"]:
                print("you have the following key: " + str(row_key["name"]))
        else:
            print("you don't have any key yet!")
        ...
        if(item["name"] == item_name):
            ...
            if(item["type"] == "door"):
                ...
                if(item["name"] in object_relations and len(object_relations[item["name"]])>0):
                    ...
                    output += "You find " + str(item_found["name"]) + "."
                else:
